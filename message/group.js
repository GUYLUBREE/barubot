...
join = '\`\`\`New Member\`\`\` \n \`\`\`Nama :\`\`\` \n \`\`\`Askot : \`\`\` \n \`\`\`Umur :\`\`\` \n \`\`\`Status :\`\`\` \n\`\`\`Kontol Or Memek:\`\`\` \n\`\`\`Anak Jb ?:\`\`\` \n\n - [ KAHFZ BOT ] -'
leave = '\`\`\`Sayonaraa Anak Kontol Keluar Awokawokawok\`\`\`'
...
module.exports = welcome = async (ikyy, anu) => {
		...
		try {
            ...
            ikyy.sendMessage(anu.jid, 'Halo! Terima Kasih sudah Mengundangku, Jika ingin Menggunakan Bot Ketik !menu', 'conversation')
             ...
             if (anu.action == 'ADA YANG MASUK GRUB' && !mem.includes(ikyy.user.jid)) {
        ...
        buttons = [
          ...
          { buttonId: `!selamatdatang`, buttonText: { displayText: "WELCOME BROO" }, type: 1 },{ buttonId: `!infogrup`, buttonText: { displayText: "INFO GRUP CEK" }, type: 1 },{ buttonId: `!gasbuli1`, buttonText: { displayText: "BULY YUK" }, type: 1},
      ...
      if (anu.action == "remove" && !mem.includes(ikyy.user.jid)) {
        ...
        buttons = [
          ...
          { buttonId: `!bay`, buttonText: { displayText: "Sayonara👋" }, type: 1 },{ buttonId: `!donasi`, buttonText: { displayText: "DONASI" }, type: 1 }];
